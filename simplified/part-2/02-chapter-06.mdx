...
<p id="2-6-1" className="verse"><a href="#2-6-1" className="verse-link" aria-label="Link to verse 2.6.1"><span className="verse-num">2.6.1</span></a> After death, a spirit does not always return at once to a new bodily life. On more highly evolved worlds, reincarnation is almost always immediate. But most often there is an interval between one incarnation and the next. In that condition, the soul is called an errant spirit.</p>
