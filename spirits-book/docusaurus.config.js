...
const config = {
  ...
  tagline: 'Based on conversations with spirits',
  ...
  organizationName: 'javanigus', // Usually your GitHub org/user name.
  projectName: 'spirits-book', // Usually your repo name.
